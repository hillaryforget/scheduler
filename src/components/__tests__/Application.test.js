...
describe("Application", () => {
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    await waitForElement(() => queryByText(appointment, "Can't save appointment!"));

    expect(getByText(appointment, "Can't save appointment!")).toBeInTheDocument();
  });
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    await waitForElement(() => queryByText(appointment, "Can't delete appointment!"));
    expect(getByText(appointment, "Can't delete appointment!")).toBeInTheDocument();
  });
